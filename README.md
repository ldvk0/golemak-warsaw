# golemak-warsaw – MOVED TO CODEBERG

⚠️ **This repository has moved to Codeberg.**
New location: [https://codeberg.org/kpiarz/golemak-warsaw](https://codeberg.org/kpiarz/golemak-warsaw)
...
Instalator: **[Releases](https://codeberg.org/kpiarz/golemak-warsaw/releases)** → `GolemakWarsawSetup.exe`.
